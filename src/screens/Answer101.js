...
export default class Answer101 extends Component {
    constructor(props) {
        super(props);
        this.state = {
        };
                        ...
                        <View style={[{
                            ...
                            <View style={{width: "100%", alignItems: 'center', flex: 1}}>
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 14, color: 'black', fontFamily:UI.FONT.demiBold}}>- Encaminhar o
                                        doente para consulta de Reabilitação Respiratória.</Text>
                                </View>
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 14, color: 'black', fontFamily:UI.FONT.demiBold}}>- Avaliar
                                        potenciais causas para não dormir bem <Text
                                            style={{fontSize: 14, fontFamily:UI.FONT.normal,letterSpacing:0.5,fontWeight: 'normal'}}>(ex: insónia, dores, refluxo
                                            gastro-esofágico, insuficiência cardíaca, apneia do sono).</Text></Text>
                                </View>
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 14, color: 'black', fontFamily:UI.FONT.demiBold}}>- Referenciar a
                                        consulta de Pneumologia/Patologia do Sono para investigação de eventuais
                                        distúrbios do sono.</Text>
                                </View>
                            </View>
                        </View>
                    </View>
