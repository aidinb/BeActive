...
export default class Answer110 extends Component {
    constructor(props) {
        super(props);
        this.state = {
        };
                        ...
                        <View style={[{
                            ...
                            <View style={{width: "100%", alignItems: 'center', flex: 1}}>
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 14, color: 'black', fontFamily:UI.FONT.demiBold}}>- Aconselhar o doente a repousar 30’ após as refeições, planeando a realização das tarefas e a sua execução no período do dia que sente mais energia.</Text>
                                </View>
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 14, color: 'black', fontFamily:UI.FONT.demiBold}}>- Incentivar maior participação nas atividades da casa. </Text>
                                </View>
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 14, color: 'black', fontFamily:UI.FONT.demiBold}}>- Fazer, com o doente, uma lista de objetivos a atingir.</Text>
                                </View>
                                <View style={{
                                    width: width - 80, borderRadius: 7, backgroundColor: UI.COLORS_HEX.primaryLight,
                                    padding: 10, justifyContent: 'center', alignItems: 'center', marginTop: 20
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 14, color: 'black', fontFamily:UI.FONT.demiBold}}>- Encaminhar o doente para consulta de Reabilitação Respiratória.</Text>
                                </View>
                            </View>
                        </View>
                    </View>
