...
export default class Answer010 extends Component {
    constructor(props) {
        super(props);
        this.state = {
        };
                        ...
                        <View style={[{
                            ...
                            <View style={{width: "100%", alignItems: 'center', flex: 1}}>
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 14, color: 'black', fontFamily:UI.FONT.demiBold}}>- Reavaliar e ajustar o tratamento farmacológico de acordo com as recomendações  <Text
                                            style={{fontSize: 14, fontFamily:UI.FONT.normal,letterSpacing:0.5,fontWeight: 'normal'}}>(mudar de molécula e/ou de inalador).</Text></Text>
                                </View>
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 14, color: 'black', fontFamily:UI.FONT.demiBold}}>- Incentivar ao aumento da atividade física diária<Text
                                        style={{fontSize: 15, fontFamily:UI.FONT.normal,letterSpacing:0.5,fontWeight: 'normal'}}>(ex: passeios curtos de 30 minutos, ir às compras, passear o cão, ir ao café).</Text></Text>
                                </View>
