                        ...
                        <View style={[{
                            ...
                            <View style={{width: "100%", alignItems: 'center', flex: 1}}>
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 15, color: 'black', fontFamily:UI.FONT.demiBold}}>- Reavaliar e
                                        ajustar o tratamento farmacológico de acordo com as recomendações <Text
                                            style={{fontSize: 15, fontFamily: UI.FONT.normal,letterSpacing:0.5,fontWeight: 'normal'}}>(mudar de
                                            molécula e/ou de inalador).</Text></Text>
                                </View>
                                <View style={{
                                    width: width - 80, marginTop: 10,
                                    paddingLeft: 10, paddingRight: 10
                                }}>
                                    <Text style={{fontSize: 15, color: 'black', fontFamily:UI.FONT.demiBold}}>- Considerar
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 15, color: 'black', fontFamily:UI.FONT.demiBold}}>- Avaliar outras
                                        comorbilidades que possam contribuir para o cansaço <Text
                                            style={{fontSize: 15, fontFamily:UI.FONT.normal,letterSpacing:0.5,fontWeight: 'normal'}}>(ex: insuficiência cardíaca,
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 15, color: 'black', fontFamily:UI.FONT.demiBold}}>- Aconselhar o
                                        doente a repousar 30’ após as refeições, planeando a realização das tarefas e a
                                        sua execução no período do dia que sente mais energia.
                                    </Text>
                                </View>
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 15, color: 'black', fontFamily:UI.FONT.demiBold}}>- Encaminhar o
                                        doente para consulta de Reabilitação Respiratória.
