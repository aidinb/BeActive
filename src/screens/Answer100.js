...
export default class Answer111 extends Component {
    constructor(props) {
        super(props);
        this.state = {
        };
                        ...
                        <View style={[{
                            ...
                            <View style={{width: "100%", alignItems: 'center', flex: 1}}>
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 14, color: 'black', fontFamily:UI.FONT.demiBold}}>- Avaliar outras
                                        comorbilidades que possam contribuir para o cansaço <Text
                                            style={{fontSize: 14, fontFamily:UI.FONT.normal,letterSpacing:0.5,fontWeight: 'normal'}}> (ex: insuficiência cardíaca,
                                            disritmias, tromboembolismo pulmonar crónico, anemia,
                                            hipotiroidismo).</Text></Text>
                                </View>
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 14, color: 'black', fontFamily:UI.FONT.demiBold}}>- Aconselhar o
                                        doente a fazer uma refeição ligeira ao jantar.</Text>
                                </View>
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 14, color: 'black', fontFamily:UI.FONT.demiBold}}>- Incentivar ao
                                        aumento da atividade física diária <Text
                                            style={{fontSize: 14, fontFamily:UI.FONT.normal,letterSpacing:0.5,fontWeight: 'normal'}}> (ex: passeios curtos de 30
                                            minutos, ir às compras, passear o cão, ir ao café).</Text></Text>
                                </View>
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 14, color: 'black', fontFamily:UI.FONT.demiBold}}>- Incentivar maior
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 14, color: 'black', fontFamily:UI.FONT.demiBold}}>- Fazer, com o
                                        doente, uma lista de objetivos a atingir.
                                    </Text>
                                </View>
                                <View style={{
                                    width: width - 80, borderRadius: 7, backgroundColor: UI.COLORS_HEX.primaryLight,
                                ...
                                <View style={{
                                    ...
                                    <Text style={{fontSize: 14, color: 'black', fontFamily:UI.FONT.demiBold}}>- Encaminhar o doente para consulta de Reabilitação Respiratória.
                                    </Text>
                                </View>
